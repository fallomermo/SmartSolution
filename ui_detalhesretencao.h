...
public:
    ...
    void setupUi(QDialog *DetalhesRetencao)
    {
        ...
        DetalhesRetencao->resize(539, 219);
        ...
        gridLayout_2->addWidget(groupBox_Resultados, 1, 1, 1, 1);
        ...
        gridLayout_3->addWidget(percentualRetido, 0, 0, 1, 1);
    ...
    {
        DetalhesRetencao->setWindowTitle(QApplication::translate("DetalhesRetencao", "Dialog", Q_NULLPTR));
        groupBox_Resultados->setTitle(QApplication::translate("DetalhesRetencao", "Resultados", Q_NULLPTR));
        campoNumeroAdmitidos->setText(QString());
        label_3->setText(QApplication::translate("DetalhesRetencao", "N\303\272mero e Admitidos:", Q_NULLPTR));
        campoNumeroDemitidos->setText(QString());
        label_6->setText(QApplication::translate("DetalhesRetencao", "N\303\272mero e Demitidos:", Q_NULLPTR));
        campoPeriodoApuracao->setText(QString());
        label_9->setText(QApplication::translate("DetalhesRetencao", "Per\303\255odo:", Q_NULLPTR));
        groupBox_Status->setTitle(QApplication::translate("DetalhesRetencao", "Reten\303\247\303\243o", Q_NULLPTR));
        percentualRetido->setText(QApplication::translate("DetalhesRetencao", "%", Q_NULLPTR));
        groupBox_Responsavel->setTitle(QApplication::translate("DetalhesRetencao", "Respons\303\241vel pela Sele\303\247\303\243o", Q_NULLPTR));
